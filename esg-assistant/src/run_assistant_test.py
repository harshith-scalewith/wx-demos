# Updated script to replace %s with each company name and fill a CSV file with company, question, and response
import os
...
output_file = 'qa_output.csv'  # Use CSV format
...
print(f'Company, questions, and answers saved to {output_file}')
